...
#pragma region Constant
	public:
		int paralle_var_num;
		int paralle_clause_num;
		int cardinality_var_num;
		int cardinality_clause_num;
...
#pragma region Method
	...
	protected:
		...
		// optimize by a single worker.
		void sequential_counter_less(int nodeNum, int centerNum, const std::string & file_name, std::vector<std::vector<ID>>& belongTo, std::set<std::vector<ID>>& atLeasttrueSets);
		std::vector<int>  recursive_counter(std::ofstream &ofs, int n, int start, int end);
		void paralle_counter_less(int nodeNum, int centerNum, const std::string & file_name, std::vector<std::vector<ID>>& belongTo, std::set<std::vector<ID>>& atLeasttrueSets);
		...
		void half_adder(std::ofstream &ofs, int a, int b, int s_out, int c_out);
